...
/**
 * @author ：yangzengrui
 * @date ：Created in 10/4/2019 10:53 PM
 * @description：
 */
...
public class AdminController {
    ...
    public String addStudentUI(Model model) throws Exception{
        ...
        model.addAttribute("collegeService", list);
    ...
    public String addTheacher(TeacherCustom teacherCustom, Model model) throws  Exception{
    ...
    public String editTeacherUI(Integer id, Model model) throws Exception{
        ...
        if(teacherCustom == null){
            throw new CustomException("未找到该学生");
        }
        List<College> list = collegeService.findAll();
        model.addAttribute("collegeList", list);
