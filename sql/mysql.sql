...
CREATE TABLE `college`(
  ...
  `collegeName` varchar(200) NOT NULL COMMENT '课程表',
   PRIMARY KEY (`collageID`)
) ENGINE=InnoDB DEFAULT CHARACTER_SET_CATALOG =utf8;

INSERT INTO `collage` VALUES ('1', '计算机系');
INSERT INTO `collage` VALUES ('2', '数学系');
INSERT INTO `collage` VALUES ('3', '艺术系');
